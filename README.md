...
- **Standardizing Formats** - Converted columns to appropriate data types—ensuring student counts were integers, scores were decimals/numbers, and regional codes maintained leading zeros where necessary.
...
- **Conditional Formatting** - Applied color scales (Green-Yellow-Red) to Economically Disadvantaged and EB/EL Students percentages, highlighted specific "High Performing" districts using rule-based formatting to make outliers immediately visible.
...
### 9.2 Geographic Distribution (Map Visual)
...
4. Impact of the EB/EL Population
...
1. Correlation Analysis: The Impact of Poverty
...
3. Outlier Analysis: "The Resilient vs. The Struggling"
By filtering the data for outliers, we identified districts that defy the expected trends.
A. Resilient Districts (High Poverty, High Performance)
...
B. Underperforming Low-Poverty Districts
...
1. Regression Modeling: The Forecasting Engine
...
o	Predictive Insight: For every 10% decrease in a district's poverty level, the model predicts an average increase of 2.15 points in their Overall Score.
...
o	Predictive Insight: This suggests that districts with robust language support programs can actually leverage student growth metrics to maintain or improve their overall ratings, regardless of language barriers.
...
1. Resource Allocation: The 60% Poverty Threshold
...
2. Instructional Strategy: Replicating the "Resilient 36%"
...
3. Language Support: Prioritizing Growth Metrics
...
•	Prescription: Shift the focus for high-EB/EL districts from "Student Achievement" (raw STAAR scores) to "School Progress" (Growth). * Action: State-level evaluations for these districts should place a 10% higher weight on the Growth domain. This incentivizes schools to focus on individual student progress, which the diagnostic analysis proves is their greatest area of strength.
4. Early Warning System: Predictive Performance Flags
...
A school year accountability rating project built with Power BI.

## Overview

This repository contains the documentation and files for a Power BI project focused on evaluating school accountability ratings and performance metrics.

## Contents

- `README.md` - Project overview and instructions
- `Documentaion mini project 2.docx` - Project documentation (Word document)

## Notes

- Ensure the project documentation is reviewed for spelling and formatting.
- If you want the Word document content reformatted, please provide the text or convert it to a supported format. 
